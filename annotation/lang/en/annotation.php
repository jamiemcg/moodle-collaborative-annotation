...
$string['documenttype_help'] = 'Select the correct document type to ensure correct rendering.';
...
$string['groupannotation'] = 'Group Annotation';
$string['groupannotations'] = 'Students annotate in groups';
$string['groupannotations_help'] = 'If enabled, students will be divided into groups based on the default group settings for this course. Users will then be able to filter annotations by groups.';
$string['groupannotation_tip'] = 'If you are enabling group support, please ensure you have assigned users to groups for the current course';
$string['groupannotationsvisible'] = 'Students can view annotations from other groups';
$string['groupannotationsvisible_help'] = 'If enabled, students will be able to view annotations created by other groups that they do not belong to. Teachers will be able to view annotations from all groups.';
$string['image'] = 'Image';
