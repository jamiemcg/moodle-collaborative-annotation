...
$string['modulename_help'] = 'The annotation module allows users to collaboratively annotate documents. Accepted formats are Plain Text Documents, Source Code and Images.';
...
$string['allow_annotations_until_help'] = 'If enabled, students will not be able to annotate the file after this date. They will still be able to view the file and any existing annotations. If disabled, students will always be able to view and annotate the file. If disabled, all students will be able to see each others annotations.';
