            ...
            Filter.prototype.options = {
                ...
                isFiltered: function(input, property) {
                    ...
                    for (_k = 0, _len2 = _ref4.length; _k < _len2; _k++) {
                        keyword = _ref4[_k];
                        if (property.toUpperCase().indexOf(keyword.toUpperCase()) === -1) {
                            return false
                        }
                    }
                    return true
        ...
        Annotator.Plugin.Tags.filterCallback = function(input, tags) {
            ...
            if (input) {
                ...
                for (_k = 0, _len2 = keywords.length; _k < _len2; _k++) {
                    keyword = keywords[_k].toUpperCase(); //Make case insensitive
                    if (tags.length) {
                        for (_l = 0, _len3 = tags.length; _l < _len3; _l++) {
                            tag = tags[_l].toUpperCase(); //Make case insensitive
